      ...
      <div className="space-y-3">
        <div>
          ...
          <textarea
            ...
            placeholder={t('QR 코드로 만들 데이터를 입력하세요...', 'Enter data to encode into QR code...')}
        ...
        <div className="text-xs space-y-0.5">
          <div className="flex justify-between">
            <span>{t('문자 수', 'Character Count')}</span>
          ...
          {dataAnalysis && !dataAnalysis.isValid && (
            <div className="text-red-600 mt-1">{t('용량 초과', 'Capacity Exceeded')}</div>
          )}
        </div>
        ...
        <div>
          ...
          <div className="space-y-1">
            ...
            <div className="border-t border-gray-200 pt-2 mt-2">
              <div className="text-[10px] text-gray-500 mb-1">{t('실용 사례', 'Practical Examples')}</div>

              <button
                onClick={() => setInputData('WIFI:T:WPA;S:MyWiFi;P:password123;H:false;;')}
                className="w-full text-left text-xs p-1 text-blue-600 hover:text-blue-800 hover:underline focus:outline-none"
              >
                <span className="font-medium">Wi-Fi:</span> {t('네트워크 연결', 'Network Connection')}
              </button>
              ...
              <button
                ...
                className="w-full text-left text-xs p-1 text-blue-600 hover:text-blue-800 hover:underline focus:outline-none"
              >
                <span className="font-medium">{t('연락처:', 'Contact:')}</span> {t('vCard 형식', 'vCard Format')}
              </button>
              ...
              <button
                ...
                className="w-full text-left text-xs p-1 text-blue-600 hover:text-blue-800 hover:underline focus:outline-none"
              >
                <span className="font-medium">{t('이메일:', 'Email:')}</span> {t('메일 작성', 'Compose Email')}
              </button>
              ...
              <button
                ...
                className="w-full text-left text-xs p-1 text-blue-600 hover:text-blue-800 hover:underline focus:outline-none"
              >
                <span className="font-medium">{t('전화:', 'Phone:')}</span> {t('통화 연결', 'Make Call')}
              </button>
              ...
              <button
                ...
                className="w-full text-left text-xs p-1 text-blue-600 hover:text-blue-800 hover:underline focus:outline-none"
              >
                <span className="font-medium">{t('위치:', 'Location:')}</span> {t('지도 좌표', 'Map Coordinates')}
              </button>
              ...
              <button
                ...
                className="w-full text-left text-xs p-1 text-blue-600 hover:text-blue-800 hover:underline focus:outline-none"
              >
                <span className="font-medium">{t('앱스토어:', 'App Store:')}</span> {t('앱 다운로드', 'App Download')}
              </button>
              ...
              <button
                ...
                className="w-full text-left text-xs p-1 text-blue-600 hover:text-blue-800 hover:underline focus:outline-none"
              >
                <span className="font-medium">Facebook:</span> {t('프로필 연결', 'Profile Link')}
              </button>
              ...
              <button
                ...
                className="w-full text-left text-xs p-1 text-blue-600 hover:text-blue-800 hover:underline focus:outline-none"
              >
                <span className="font-medium">Instagram:</span> {t('프로필 방문', 'Profile Visit')}
              </button>
